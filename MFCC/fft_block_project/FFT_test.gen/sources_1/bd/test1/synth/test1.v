...
(* CORE_GENERATION_INFO = "test1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=test1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=7,numReposBlks=7,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=12,da_board_cnt=1,da_clkrst_cnt=4,da_ps7_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "test1.hwdef" *) 
module test1
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  wire [15:0]fft_config_dma_M_AXIS_MM2S_TDATA;
  wire fft_config_dma_M_AXIS_MM2S_TREADY;
  wire fft_config_dma_M_AXIS_MM2S_TVALID;
  wire [31:0]fft_config_dma_M_AXI_MM2S_ARADDR;
  wire [1:0]fft_config_dma_M_AXI_MM2S_ARBURST;
  wire [3:0]fft_config_dma_M_AXI_MM2S_ARCACHE;
  wire [7:0]fft_config_dma_M_AXI_MM2S_ARLEN;
  wire [2:0]fft_config_dma_M_AXI_MM2S_ARPROT;
  wire fft_config_dma_M_AXI_MM2S_ARREADY;
  wire [2:0]fft_config_dma_M_AXI_MM2S_ARSIZE;
  wire fft_config_dma_M_AXI_MM2S_ARVALID;
  wire [63:0]fft_config_dma_M_AXI_MM2S_RDATA;
  wire fft_config_dma_M_AXI_MM2S_RLAST;
  wire fft_config_dma_M_AXI_MM2S_RREADY;
  wire [1:0]fft_config_dma_M_AXI_MM2S_RRESP;
  wire fft_config_dma_M_AXI_MM2S_RVALID;
  wire [63:0]fft_data_dma_M_AXIS_MM2S_TDATA;
  wire fft_data_dma_M_AXIS_MM2S_TLAST;
  wire fft_data_dma_M_AXIS_MM2S_TREADY;
  wire fft_data_dma_M_AXIS_MM2S_TVALID;
  ...
  test1_axi_dma_0_1 fft_config_dma
       (.axi_resetn(proc_sys_reset_0_peripheral_aresetn),
        .m_axi_mm2s_aclk(processing_system7_0_FCLK_CLK0),
        .m_axi_mm2s_araddr(fft_config_dma_M_AXI_MM2S_ARADDR),
        .m_axi_mm2s_arburst(fft_config_dma_M_AXI_MM2S_ARBURST),
        .m_axi_mm2s_arcache(fft_config_dma_M_AXI_MM2S_ARCACHE),
        .m_axi_mm2s_arlen(fft_config_dma_M_AXI_MM2S_ARLEN),
        .m_axi_mm2s_arprot(fft_config_dma_M_AXI_MM2S_ARPROT),
        .m_axi_mm2s_arready(fft_config_dma_M_AXI_MM2S_ARREADY),
        .m_axi_mm2s_arsize(fft_config_dma_M_AXI_MM2S_ARSIZE),
        .m_axi_mm2s_arvalid(fft_config_dma_M_AXI_MM2S_ARVALID),
        .m_axi_mm2s_rdata(fft_config_dma_M_AXI_MM2S_RDATA),
        .m_axi_mm2s_rlast(fft_config_dma_M_AXI_MM2S_RLAST),
        .m_axi_mm2s_rready(fft_config_dma_M_AXI_MM2S_RREADY),
        .m_axi_mm2s_rresp(fft_config_dma_M_AXI_MM2S_RRESP),
        .m_axi_mm2s_rvalid(fft_config_dma_M_AXI_MM2S_RVALID),
        .m_axis_mm2s_tdata(fft_config_dma_M_AXIS_MM2S_TDATA),
  ...
  test1_axi_dma_0_0 fft_data_dma
       (.axi_resetn(proc_sys_reset_0_peripheral_aresetn),
        .m_axi_mm2s_aclk(processing_system7_0_FCLK_CLK0),
        ...
        .m_axis_mm2s_tdata(fft_data_dma_M_AXIS_MM2S_TDATA),
  ...
  test1_proc_sys_reset_0_0 proc_sys_reset_0
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  test1_processing_system7_0_0 processing_system7_0
       (.DDR_Addr(DDR_addr),
        .DDR_BankAddr(DDR_ba),
        .DDR_CAS_n(DDR_cas_n),
        .DDR_CKE(DDR_cke),
  ...
  test1_smartconnect_0_0 smartconnect_0
       (.M00_AXI_araddr(smartconnect_0_M00_AXI_ARADDR),
        ...
        .S02_AXI_araddr(fft_config_dma_M_AXI_MM2S_ARADDR),
        .S02_AXI_arburst(fft_config_dma_M_AXI_MM2S_ARBURST),
        .S02_AXI_arcache(fft_config_dma_M_AXI_MM2S_ARCACHE),
        .S02_AXI_arlen(fft_config_dma_M_AXI_MM2S_ARLEN),
        .S02_AXI_arlock(1'b0),
        .S02_AXI_arprot(fft_config_dma_M_AXI_MM2S_ARPROT),
        .S02_AXI_arqos({1'b0,1'b0,1'b0,1'b0}),
        .S02_AXI_arready(fft_config_dma_M_AXI_MM2S_ARREADY),
        .S02_AXI_arsize(fft_config_dma_M_AXI_MM2S_ARSIZE),
        .S02_AXI_arvalid(fft_config_dma_M_AXI_MM2S_ARVALID),
        .S02_AXI_rdata(fft_config_dma_M_AXI_MM2S_RDATA),
        .S02_AXI_rlast(fft_config_dma_M_AXI_MM2S_RLAST),
        .S02_AXI_rready(fft_config_dma_M_AXI_MM2S_RREADY),
        .S02_AXI_rresp(fft_config_dma_M_AXI_MM2S_RRESP),
        .S02_AXI_rvalid(fft_config_dma_M_AXI_MM2S_RVALID),
        .aclk(processing_system7_0_FCLK_CLK0),
        .aresetn(proc_sys_reset_0_peripheral_aresetn));
  test1_xfft_0_0 xfft_0
       (.aclk(processing_system7_0_FCLK_CLK0),
        .aresetn(proc_sys_reset_0_peripheral_aresetn),
